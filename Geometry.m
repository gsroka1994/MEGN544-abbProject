...
L1 = createLink(0,d1,-pi/2,[],0,rcom1, m1,J1);
L2 = createLink(a2,0,0,[],pi/2,rcom2, m2,J2);
L3 = createLink(a3,0,-pi/2,[],0,rcom3, m3,J3);
L4 = createLink(0,d4,pi/2,[],0,rcom4, m4,J4);
L5 = createLink(0,0,-pi/2,[],0,rcom5, m5,J5);
L6 = createLink(0,d6,0,[],0,rcom6, m6,J6);
